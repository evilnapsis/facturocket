...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h2 class="fw-bold text-dark mb-1">Usos de CFDI</h2>
        <p class="text-muted mb-0">Administración del catálogo de Usos de CFDI del SAT.</p>
    </div>
    ...
    <div class="card-body p-4">
        <div class="table-responsive">
            <table class="table table-hover align-middle datatable">
                ...
                <tbody>
                    <?php foreach(CfdiUseData::getAll() as $item): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="./?action=cfdiuses&opt=del&id=<?php echo $item->id; ?>" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
                    ...
                    <div class="modal fade" id="editModal<?php echo $item->id; ?>" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content border-0 shadow">
                                ...
                                <form method="post" action="./?action=cfdiuses&opt=upd">
...
<div class="modal fade" id="newModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content border-0 shadow">
            ...
            <form method="post" action="./?action=cfdiuses&opt=add">
            <div class="modal-body p-4">
                <div class="mb-3">
                    <label class="form-label fw-bold">Código SAT</label>
