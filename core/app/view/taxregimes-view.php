...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h2 class="fw-bold text-dark mb-1">Regímenes Fiscales</h2>
        <p class="text-muted mb-0">Administración de los catálogos de regímenes fiscales del SAT.</p>
    </div>
    <button type="button" class="btn btn-primary fw-bold shadow-sm" data-coreui-toggle="modal" data-coreui-target="#newModal">
        <i class="bi bi-plus-lg me-2"></i> Nuevo Régimen
    </button>
</div>
    ...
    <div class="card-body p-4">
        <div class="table-responsive">
            <table class="table table-hover align-middle datatable">
                ...
                <tbody>
                    <?php foreach(TaxRegimeData::getAll() as $item): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="./?action=taxregimes&opt=del&id=<?php echo $item->id; ?>" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content border-0 shadow">
                                <div class="modal-header border-bottom-0 pt-4 px-4">
                                    <h5 class="modal-title fw-bold">Editar Régimen</h5>
                                    <button type="button" class="btn-close" data-coreui-dismiss="modal"></button>
                                </div>
                                <form method="post" action="./?action=taxregimes&opt=upd">
...
<div class="modal fade" id="newModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-bottom-0 pt-4 px-4">
                <h5 class="modal-title fw-bold">Nuevo Régimen Fiscal</h5>
                <button type="button" class="btn-close" data-coreui-dismiss="modal"></button>
            </div>
            <form method="post" action="./?action=taxregimes&opt=add">
            <div class="modal-body p-4">
                <div class="mb-3">
                    <label class="form-label fw-bold">Código SAT</label>
            ...
            <div class="modal-footer border-top-0 pb-4 px-4">
                <button type="button" class="btn btn-light fw-bold" data-coreui-dismiss="modal">Cancelar</button>
                <button type="submit" class="btn btn-primary fw-bold">Crear Régimen</button>
            </div>
            </form>
        </div>
    </div>
